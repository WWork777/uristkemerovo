...
export const metadata = {
  title: "Контакты Юрист Кемерово — адрес офиса, телефон, консультация",
  description:
    "Контакты Юрист Кемерово: адрес офиса, телефон, e‑mail. Запишитесь на бесплатную консультацию.",
  keywords:
  ...
  alternates: {
    canonical: "https://юристкемерово.рф/kontakty",
  },
  openGraph: {
    title: "Контакты Юрист Кемерово — адрес офиса, телефон, консультация",
    description:
      "Контакты Юрист Кемерово: адрес офиса, телефон, e‑mail. Запишитесь на бесплатную консультацию.",
    url: "https://юристкемерово.рф/kontakty",
    images: [
      {
