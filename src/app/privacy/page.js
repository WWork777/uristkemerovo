...
export const metadata = {
  title: "Полиитика конфиденциальности",
  description: "Политика конфиденнциальности сайта юристкемерово.рф",
  keywords:
  ...
  alternates: {
    canonical: "https://юристкемерово.рф/privacy",
  },
  openGraph: {
    title: "Полиитика конфиденциальности",
    description: "Политика конфиденнциальности сайта юристкемерово.рф",
    url: "https://юристкемерово.рф/privacy",
    images: [
      {
  ...
  return (
    <section className="section-main secondary-page">
      ...
      <p>
        ...
        <br />
        <u>
          <a href="https://юристкемерово.рф">https://юристкемерово.рф;</a>
        </u>
        <a href="https://юристкемерово.рф"></a>
      </p>
      <a href="https://юристкемерово.рф">
      ...
      <p>
        ...
        почты
        <u>
          <a href="mailto:lawyer_kodeks@mail.ru">lawyer_kodeks@mail.ru</a>
        </u>{" "}
      ...
      <p>
        ...
        Интернет по адресу
        <u>
          <a href="https://юристкемерово.рф/privacy">
            https://юристкемерово.рф/privacy
          </a>
        </u>
        .
      </p>
